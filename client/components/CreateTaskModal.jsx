    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/85 backdrop-blur-md p-4">
      <div className="w-full max-w-xl overflow-hidden rounded-3xl border border-white/10 bg-slate-900 shadow-2xl">
        <div className="flex items-center justify-between border-b border-white/10 px-6 py-5 bg-slate-900">
          <div>
            <p className="text-xs uppercase tracking-[0.24em] text-sky-400 font-semibold">New Task</p>
            <h3 className="mt-1 text-xl font-bold text-white">Create a task card</h3>
          </div>
          <button 
            onClick={onClose} 
