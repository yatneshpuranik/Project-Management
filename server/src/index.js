...
import { validateQueryAndBodyIds } from "./middlewares/validate.js";
import { initializePermissionMatrix } from "./controllers/adminController.js";
...
app.use(validateQueryAndBodyIds);
